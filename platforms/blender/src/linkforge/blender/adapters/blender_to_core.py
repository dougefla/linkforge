...
class SceneToRobotTranslator:
    ...
    def translate(self) -> tuple[Robot, ValidationResult]:
        ...
        saved_positions: list[tuple[Any, float]] = []
        for jobj in joint_objects:
            ...
            if jprops and jprops.rest_initialized and jprops.joint_position != 0.0:
                saved_positions.append((jprops, jprops.joint_position))
        ...
        try:
            ...
            if root:
                ...
                self._build_link_recursive(
                    root_name, None, link_objects, joints_map, link_frames
                )
            else:
            ...
            if saved_positions:
                for jprops, saved_pos in saved_positions:
