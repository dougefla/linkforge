...
## Planning Group
A named subset of links and joints used by MoveIt to plan motion for one part of the robot (e.g., `arm`, `hand`). Planning groups are defined in the SRDF and managed through `RobotBuilder.add_group()` in LinkForge.
